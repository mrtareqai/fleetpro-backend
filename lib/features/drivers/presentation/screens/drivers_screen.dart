...
import '../../domain/providers/drivers_provider.dart';
...
class _DriversScreenState extends ConsumerState<DriversScreen> {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(AppStrings.get('drivers_management', locale),
                    ...
                    data: (drivers) {
                      ...
                      if (_searchQuery.isNotEmpty) {
                        items = items.where((d) =>
                            ...
                            d.phone.contains(_searchQuery)).toList();
                      }
                              ...
                              child: SingleChildScrollView(
                                child: DataTable(
                                  ...
                                  columns: [
                                    ...
                                    DataColumn(label: Text(AppStrings.get('name', locale))),
  ...
  Widget _buildMobileList(List<AppDriver> items, String locale) {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(AppStrings.get('phone', locale), style: const TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                  Text(d.phone, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
                ],
              ),
            ],
          ),
